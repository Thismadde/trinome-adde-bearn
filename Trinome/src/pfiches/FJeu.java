...
public class FJeu extends javax.swing.JDialog {
	...
	public FJeu(java.awt.Frame parent, boolean modal) {
		...
		Integer[] pos;
		pos = new Integer[]{4, 1};
		Piece p = new Piece(true, pos, "vert", true);
		a(p);
	}
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		jLabel1.setText(evt.getActionCommand() + ", non?");
	...
	private void a(Piece p) {
		int i = 0;
		ImageIcon icon = new ImageIcon("C:\\Users\\Utilisateur\\OneDrive\\Documents\\GitHub\\tritri\\trinome-adde-bearn\\Trinome\\recherche sprites\\cubeV.png");
		...
		for (Component b : a) {
			if (b instanceof JButton) {
				try {
					...
					jLabel1.setText(((JButton) b).getActionCommand());
