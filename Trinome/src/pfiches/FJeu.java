...
public class FJeu extends javax.swing.JDialog {
	...
	public FJeu(java.awt.Frame parent, boolean modal, boolean type, String a, String b) {
		super(parent, modal);
		initComponents();
	...
	public FJeu(java.awt.Frame parent, boolean modal, String a, String b) {
		super(parent, modal);
		initComponents();
		plato = new Plateau(a, b);
		labelPseudo1.setText(a);
		...
		else {labelInfos.setText("<html>Chargement échoué! (˘･_･˘)" + System.lineSeparator() + "Partie normale lancée.</html>");}
		afficher(plato.pionsr, plato.pionsv);
	}
    ...
    private void initComponents() {
        ...
        jButton122.setText("Quitter et Sauver (～￣▽￣)～");
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		if (plato.endGame()) {
			...
			switch (step) {
				case "choix":
					if (plato.choix(posi).equals("")) {
						((JButton) evt.getSource()).setBackground(Color.DARK_GRAY);
						step = "cible";
