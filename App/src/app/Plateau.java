            ...
            while(ligne!=null){
                ...
                if (c=="rouge"){ 
                    for (String pion: pions){
                        ...
                        switch(infos[0]){
                            case "Sphere ": Sphere p = new Sphere(Boolean.parseBoolean(infos[3]), q , "rouge",Boolean.parseBoolean(infos[4]));
                            pionsr.add(p);
                            break;
                            case "Sphere S ": SphereSpe p2 = new SphereSpe(Boolean.parseBoolean(infos[3]), q , "rouge",Boolean.parseBoolean(infos[4]));
                            pionsr.add(p2);
                            break;
                            case "Cube ": Cube p3 = new Cube(Boolean.parseBoolean(infos[3]), q , "rouge",Boolean.parseBoolean(infos[4]));
                            pionsr.add(p3);
                            break;
                            case "Cube S ": CubeSpe p4 = new CubeSpe(Boolean.parseBoolean(infos[3]), q , "rouge",Boolean.parseBoolean(infos[4]));
                            pionsr.add(p4);
                            break;
                            case "Pyramide ": Pyramide p5 = new Pyramide(Boolean.parseBoolean(infos[3]), q , "rouge",Boolean.parseBoolean(infos[4]));
                            pionsr.add(p5);
                            break;
                            case "Pyramide S ": PyramSpe p6 = new PyramSpe(Boolean.parseBoolean(infos[3]), q , "rouge",Boolean.parseBoolean(infos[4]));
                            pionsr.add(p6);
                            break;
                            default: break;
                        }
                ...
                if (c=="vert"){ 
                    for (String pion: pions){
                        ...
                        Integer[] q = {Integer.valueOf(infos[1]),Integer.valueOf(infos[2])};
                        switch(infos[0]){
                            case "Sphere ": Sphere p = new Sphere(Boolean.parseBoolean(infos[3]), q , "vert",Boolean.parseBoolean(infos[4]));
                            pionsv.add(p);
                            break;
                            case "Sphere S ": SphereSpe p2 = new SphereSpe(Boolean.parseBoolean(infos[3]), q , "vert",Boolean.parseBoolean(infos[4]));
                            pionsv.add(p2);
                            break;
                            case "Cube ": Cube p3 = new Cube(Boolean.parseBoolean(infos[3]), q , "vert",Boolean.parseBoolean(infos[4]));
                            pionsv.add(p3);
                            break;
                            case "Cube S ": CubeSpe p4 = new CubeSpe(Boolean.parseBoolean(infos[3]), q , "vert",Boolean.parseBoolean(infos[4]));
                            pionsv.add(p4);
                            break;
                            case "Pyramide ": Pyramide p5 = new Pyramide(Boolean.parseBoolean(infos[3]), q , "vert",Boolean.parseBoolean(infos[4]));
                            pionsv.add(p5);
                            break;
                            case "Pyramide S ": PyramSpe p6 = new PyramSpe(Boolean.parseBoolean(infos[3]), q , "vert",Boolean.parseBoolean(infos[4]));
                            pionsv.add(p6);
                            break;
                            default: break;
                        }
